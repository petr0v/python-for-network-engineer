...
value = input("Введите имя устройства (" + ", ".join(london_co.keys())+ "): ")
parameter = input("Введите имя параметра (" + ", ".join(london_co[value].keys()) + "): ")

print(london_co[value].get(parameter.lower(), "Такого параметра нет"))
