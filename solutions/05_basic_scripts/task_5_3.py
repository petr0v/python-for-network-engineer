...
dict_port = dict(access = access_template, trunk = trunk_template)

tip_porta = input("Введите режим работы интерфейса (access/trunk): ")
interface = input("Введите тип и номер интерфейса: ")
quantity_vlan = input("Введите номер влан(ов): ")


print('interface {}'.format(interface))
print('\n'.join(dict_port[tip_porta]).format(quantity_vlan))
